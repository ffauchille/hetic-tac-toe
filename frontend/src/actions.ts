...
export function startGameAction(payload: StartGamePayload): GameStateAction & { payload: StartGamePayload } { 
    return { type: GameActions.startGame, payload } 
}

export function gameStartedAction(payload: StartGamePayload): GameStateAction & { payload: StartGamePayload } {
    return { type: GameActions.gameStarted, payload }
}

export function askToJoinGame(payload: AskToJoinGamePayload): GameStateAction & { payload: AskToJoinGamePayload} {
    return { type: GameActions.askToJoin, payload };
}

export function gameStatusUpdated(payload: GameStatusUpdate): GameStateAction & { payload: GameStatusUpdate } {
    return { type: GameActions.gameStatus, payload }
}

export function moveSaved(payload: GameStatusUpdate): GameStateAction & { payload: GameStatusUpdate } {
    return { type: GameActions.moveSaved, payload }
}

export function anotherPlayerJoined(payload: GameStatusUpdate): GameStateAction & { payload: GameStatusUpdate} {
    return { type: GameActions.anotherPlayerJoined, payload };
}

export function currentPlayerMovedAction(payload: CurrentPlayerMoved): GameStateAction & { payload: CurrentPlayerMoved } {
